...
function Bcube._append_bilinear!(I, J, X, offset, row, col, vals, backend::AbstractBcubeBackendAcc)
...
function _ndofs_element_bilinear_kernel(elementInfo::CellInfo, U, V)
...
function Bcube.allocate_bilinear(backend::AbstractBcubeBackendAcc, a, U, V, T)
    ...
    ndofs = Bcube.map_element(e -> _ndofs_element_bilinear_kernel(e, U, V), domain)
